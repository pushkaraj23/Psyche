...
const AboutLanding = () => {
  return (
    <div className="h-auto flex flex-col justify-center items-center w-screen pt-[10vw] bg-[#f8f6f3]">
      {/* Page Title */}
      <h1 className="text-[6.5vw] pb-[7vw] md:pt-[0vw] md:text-[3vw] font-bold text-[#3F6F67] md:pb-[2.5vw]">
        About Psyche
      </h1>

      {/* Content Container with Background Image and Blurred Overlay */}
      <div className=" rounded-[17vw] md:rounded-[4vw] overflow-hidden w-[80vw] md:w-[85vw]">
        <img
          src={aboutBg}
          alt="Scenic background"
          className="w-full h-[90vw] md:h-[22vw] object-cover"
        />

        {/* Blurred Teal Section with Text */}
        <div className=" md:-mt-20 mt-0 w-full h-[97vw] md:h-[13vw] p-[5vw] md:p-[2vw] bg-[#3F6F67] backdrop-blur-sm bg-opacity-80  rounded-[17vw] md:rounded-[4vw] text-white flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="w-[60vw] md:w-[58vw] text-[3.5vw] md:text-[1.4vw] font-merriweather text-start md:mt-[1vw] mb-[1vw]">
            Psyche is committed to enhancing mental health awareness and
            providing compassionate, professional psychiatric care. Learn more
            about our journey, values, and the team behind our mission.
          </p>
        </div>
      </div>
    </div>
...
const OurStory = () => {
  return (
    <div className="flex flex-col md:flex-row h-auto w-screen bg-[#f8f6f3] md:px-[13vw] py-20 gap-[5vw] md:gap-[0vw]">
      ...
      <div className="flex flex-col w-full md:w-[50vw] gap-[5vw] md:gap-[2vw]">
        ...
        <div className="flex gap-[5vw] md:gap-[2.6vw]">
          <div className="flex flex-col items-start">
            <h1 className="text-[10vw] md:text-[3.5vw] font-bold text-[#745343] font-merriweather">
              Our
            </h1>
            <h1 className="text-[12vw] md:text-[4.5vw] font-bold text-[#745343] font-merriweather">
              Story
            </h1>
          </div>
          <img
            src={ourstory_1}
            alt="Story Image 1"
            className="rounded-[3vw] w-[42vw] md:w-[15vw] h-auto"
          />
        </div>
        {/* Second image */}
        <img
          src={ourstory_2}
          alt="Story Image 2"
          className="rounded-[3vw] w-full md:w-[30vw] h-auto"
        />
      </div>
      ...
      <div className="w-full md:w-[50vw] h-auto md:h-[38vw] p-[7vw] md:p-[3vw] bg-[#DDBEA9] rounded-[3vw] md:rounded-[2vw] text-justify text-[4vw] md:text-[1.3vw] text-[#71432B] leading-relaxed italic font-merriweather">
        <p>
          “Founded in [Year], Psyche was established to address the growing need
          for compassionate, accessible mental health care. Over the years, we
          have expanded our services from individual consultations to
          community-wide awareness programs, always guided by a commitment to
          empathy and excellence.
        </p>
        <p className="mt-[4vw] md:mt-[1vw]">
          Our journey began when our founder [Founder's Name] recognized a lack
          of accessible mental health resources in the community. Driven by the
          goal of creating an inclusive mental health resource, Psyche was born,
          aiming to offer professional psychiatric support and foster a more
...
const UserTestimonials = () => {
  return (
    <div className="flex flex-col items-center bg-[#f8f6f3] w-screen">
      {/* Title */}
      <h2 className="text-[7vw] md:text-[3vw] font-bold text-[#6B7775] m-[2.5vw]">
        User Testimonials
      </h2>
      ...
      <div className="grid gap-[5vw] md:gap-[2vw] w-[90vw]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-[5vw] md:gap-[2vw] mb-[5vw] md:mb-[3vw]">
          {testimonials.slice(0, 4).map((testimonial, index) => (
            <div
              key={index}
              className="relative flex flex-col items-center p-[5vw] md:p-[2vw] text-[#4a4a4a]"
            >
              {/* Testimonial Box */}
              ...
              <img
                ...
                className="absolute inset-y-[14vw] inset-x-[20vw] md:inset-[4vw] w-[60vw] md:w-[17vw] h-[60vw] md:h-[25vw]"
              />
            </div>
          ))}
        </div>
