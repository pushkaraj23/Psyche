  ...
  return (
    <div className="relative bg-[#f9f5f0] h-screen lg:h-[70vw] flex lg:items-center justify-center">
      ...
      <img
        src={image1}
        alt="Decorative"
        className="absolute left-0 bottom-[-0.01vw] w-[60vw] lg:w-[30vw]"
      />
      <img
        src={image2}
        alt="Decorative"
        className="absolute right-0 lg:top-[15vw] top-[50vw] w-[40vw] lg:w-[20vw]"
      />

      {/* Form Section */}
      <div className="lg:w-[60vw] text-center lg:p-[3vw] p-[20vw] mt-[10vw] lg:mt-[0vw] font-merriweather">
        <div className="pb-[3vw]">
          <h2 className="text-[8vw] lg:text-[3vw] font-bold text-[#3F6F67]">
            Contact Us
          </h2>
