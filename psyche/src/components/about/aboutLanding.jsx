...
const OurStory = () => {
    return (
        <div className="flex flex-row justify-center items-start h-screen w-screen bg-[#f8f6f3] py-[7vw] px-[13vw] gap-[1vw]">
            ...
            <div className="flex flex-col w-[50vw] gap-[2vw]">
                {/* Title and first image row */}
                <div className="flex items-start gap-[2.6vw]">
            ...
            <div className="w-[50vw] h-[38vw] p-[5vw] bg-[#DDBEA9] rounded-[2vw] text-justify text-[1.25vw] text-[#71432B] leading-relaxed italic font-merriweather">
                <p>
