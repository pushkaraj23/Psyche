    ...
    return (
        <div className="w-[65vw] sm:w-[60vw] lg:w-[24vw] bg-white overflow-hidden border border-[#d2d4a4]">
            ...
            <div className="p-[4vw] sm:p-[3vw] md:p-[2vw]">
                ...
                <a href="#" className="inline-block bg-[#8D8F69] font-merriweather text-white px-[2vw] py-[1vw] sm:px-[1vw] sm:py-[0.7vw] rounded-sm hover:bg-white hover:text-[#8D8F69] border border-[#8D8F69] transition-colors duration-300">
                    Learn More →
                </a>
            </div>
        </div>
